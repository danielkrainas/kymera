(function (global) {
    ...
    var buildClass = function (m, name, def) {
        ...
        proto.constructor = function () {
            ...
            if (def.ctor) {
                // TODO: pass any arguments to the defined ctor and inject any other needed
    ...
    var StoreAttribute = function (options) {
        this.initialState = kymera.mixin({}, options.state);
    };

    StoreAttribute.makeStateful = function (initialState) {
        return {
            getInitialState: function () {
                return initialState;
            },
            getState: function () {
                return this.__state__ || this.getInitialState();
            },
            setState: function (newState) {
                // TODO: should merge instead of a shallow copy
                this.__state__ = kymera.mixin(this.__state__, newState);
            }
        };
    };

    StoreAttribute.prototype.attach = function (m, T) {
        var statefulMixin = StoreAttribute.makeStateful(this.initialState);
        kymera.mixin(T.prototype, statefulMixin);
    };

    StoreAttribute.prototype.attachTo = function (m, T, t) {
        var state = null;
        Object.defineProperty(t, '__state__', {
            expandable: false,
            get: function () {
                return state;
            },
