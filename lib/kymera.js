...
var ServiceResolver = function (parent) {
	this.container = {};
};

ServiceResolver.prototype.register = function (name, ctor) {
...
ServiceResolver.prototype.resolve = function (name) {
	var svc = this.container[name];
	if (!svc) {
		return null;
	}
